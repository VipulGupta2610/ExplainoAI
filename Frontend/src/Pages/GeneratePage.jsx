...
export default function GeneratePage() {
  ...
  return (
    <main className="min-h-screen px-4 sm:px-6 pt-28 sm:pt-32 pb-16 bg-white dark:bg-black text-black dark:text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-12">
          ...
          <div className="space-y-8 sm:space-y-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                {["reel", "short", "full"].map((type) => (
                  <button
                    ...
                    className={`p-3 sm:p-4 rounded-xl border ${info.Video_Type === type
            ...
            <section>
              ...
              <div className="space-y-4 text-sm text-gray-500">
                ...
                <label className="flex justify-between items-center gap-4 opacity-75">
                  Background Music
                  <input
                  disabled
            ...
            <div className="mt-10 sm:mt-16 max-w-4xl mx-auto">
              <motion.button
                ...
                className={`w-full py-4 text-base sm:text-lg rounded-xl font-semibold transition ${isGenerating
        ...
        <div className="space-y-8">
          {isGenerating ? (
            <div className="p-4 sm:p-6 rounded-2xl bg-gray-100 dark:bg-gray-900">
              <h3 className="font-semibold mb-4">
                Generating Your Video...
              </h3>
              <div className="animate-pulse space-y-4">
                <div className="h-[300px] sm:h-[400px] rounded-2xl bg-gray-300 dark:bg-gray-800"></div>
          ...
          <div className="p-4 sm:p-6 rounded-2xl bg-blue-100 dark:bg-blue-900">
      ...
      <section className="mt-16 sm:mt-20 max-w-5xl mx-auto text-center">
        <h2 className="text-2xl font-semibold mb-6">
          Tips for better videos
        </h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 text-sm text-gray-500">
